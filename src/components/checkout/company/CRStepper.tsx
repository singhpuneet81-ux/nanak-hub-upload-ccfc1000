...
import { Check, Building2, Users, UserCheck, Gift, Sparkles, CreditCard } from "lucide-react";
...
interface CRStepperProps {
  currentStep: number;
  onStepClick?: (step: number) => void;
}

export const CRStepper: React.FC<CRStepperProps> = ({ currentStep, onStepClick }) => {
