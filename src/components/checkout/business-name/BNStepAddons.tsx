...
const ADD_ONS: AddOn[] = [
  {
    ...
    whyNeeded:
      "Required if your business turnover exceeds $75,000 annually, or if you want to claim GST credits on business purchases.",
    recommended: true,
  },
  {
    ...
    whyNeeded:
      "Protects your privacy by keeping your home address off public registers and ensures ASIC compliance.",
  },
];

export const BNStepAddons: React.FC = () => {
    ...
    <div className="content-card animate-fade-in">
      ...
      <div className="mb-6">
        ...
        <p className="text-muted-foreground mt-1">
          Optional services to simplify compliance
        </p>
      </div>
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6 flex items-start gap-3">
        ...
        <p className="text-sm text-blue-800">
          These are commonly selected add-ons for new businesses.
        </p>
      </div>
