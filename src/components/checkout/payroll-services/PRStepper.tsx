...
const steps = [
  ...
  { number: 2, label: "Add-ons", sub: "One-time services" },
  { number: 3, label: "Entity Details", sub: "Your information" },
...
export const PRStepper: React.FC<Props> = ({ currentStep, onStepClick }) => {
  ...
  return (
    <div className="w-full px-4 py-4 md:px-8 md:py-6 bg-background">
          ...
          return (
            <React.Fragment key={step.number}>
              ...
              >
                ...
                <p
                  className={`
                    mt-1.5 text-xs font-medium whitespace-nowrap hidden md:block text-center
