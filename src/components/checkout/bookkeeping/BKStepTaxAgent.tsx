...
export const BKStepTaxAgent: React.FC<Props> = ({ onNext, onBack }) => {
  const { customer, updateCustomer } = useCheckout();
  const [method, setMethod] = useState((customer.bkTaxAgentMethod as string) || "mygov");

  const handleContinue = () => {
    updateCustomer({ bkTaxAgentMethod: method });
    onNext();
  };
